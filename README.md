...
1.  **START SCAN:** Begins the scraping and checking process immediately.
2.  **CONFIGURATION:** Allows you to change settings:
...
| :--- | :--- | :--- |
| `proxies_detailed.txt` | `IP:PORT | LATENCY` | Good for analyzing speed. |
| `proxies_raw.txt` | `IP:PORT` | Good for copy-pasting into other bots/tools. |
